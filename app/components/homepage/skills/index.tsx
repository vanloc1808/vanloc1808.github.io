...
const Skills: FC = () => {
  return (
    <div
      id="skills"
      className="relative z-50 border-t my-12 lg:my-24 border-[#e4e4e7] dark:border-[#25213b]"
    >
      ...
      <div className="w-full my-12">
        ...
        >
          {skillsData.map((skill: string, id: number) => (
            ...
            >
              <div className="h-full w-full rounded-lg border border-gray-300 dark:border-[#1f223c] bg-white dark:bg-[#11152c] shadow-md dark:shadow-none group-hover:border-violet-500 transition-all duration-500">
